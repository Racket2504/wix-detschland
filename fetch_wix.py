...
# Q1'26: Eurostat-Inflationsdatensatz (prc_hicp_manr) hinkt hinterher (Stand
# dieses Laufs: letzter Punkt Dez. 2025) — für dieses eine Quartal wurde der
# FALLBACK-Inflationswert statt eines echten Eurostat-Punkts verwendet, damit
# das Quartal nicht aus der Historie fällt (siehe fetch_history.py).
